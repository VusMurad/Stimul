<?php $this->load->view('admin/includes/headlinks') ?>
    <title>Create | ACCA, CIA, DipIFR, CFA</title>
<?php ; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url($uri = 'acca_create_act');?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                                <a href="<?php echo base_url('acca');?>">
                                    <button type="submit" class="btn btn-primary btn-center form-control">Send</button>
                                </a>
                            </div>
