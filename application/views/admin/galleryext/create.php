    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url($uri = 'gallery_create_act'); ?>" method="post" enctype="multipart/form-data">                    

                            <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12 myinput">
                                <div class="col-xs-12 col-sm-12 col-lg-3 col-md-3">
                                    <label for="name">Şəklin adı</label>
                                    <input type="text" name="name" id="name" class="form-control" required="">
                                </div>

                                <div class="col-xs-12 col-sm-12 col-lg-3 col-md-3">
                                    <label for="name">Şəklin adı (eng)</label>
                                    <input type="text" name="engname" id="name" class="form-control" required="">
                                </div>

                                <div class="col-xs-12 col-sm-12 col-lg-3 col-md-3">
                                    <label for="name">Şəklin adı (ru)</label>
