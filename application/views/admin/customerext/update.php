    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url($uri = 'customers_update_act/' . $get_single_customer['cs_id']); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12 myinput">
                                ...
                                <div class="col-xs-12 col-sm-12 col-lg-8 col-md-8">
                                    <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" value="<?php echo $get_single_customer['cs_name']; ?>" required="">
                                    </div><br>

                                    <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                                        <label for="engname">Kursun adı (eng)</label>
                                        <input type="text" name="engname" id="engname" class="form-control" value="<?php echo $get_single_customer['cs_name_eng']; ?>" required="">
                                    </div><br>

                                    <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                                        <label for="runame">Kursun adı (ru)</label>
                                        <input type="text" name="runame" id="runame" class="form-control" value="<?php echo $get_single_customer['cs_name_ru']; ?>" required="">
                                    </div>
                                </div>
                            </div>
